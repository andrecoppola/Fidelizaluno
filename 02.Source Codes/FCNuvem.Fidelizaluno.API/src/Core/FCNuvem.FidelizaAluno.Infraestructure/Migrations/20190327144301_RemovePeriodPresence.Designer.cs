...
namespace FCNuvem.FidelizaAluno.Infraestructure.Migrations
{
    ...
    [Migration("20190327144301_RemovePeriodPresence")]
    partial class RemovePeriodPresence
    {
            ...
            modelBuilder.Entity("FCNuvem.FidelizaAluno.Core.Entities.EvasionHistoryEntity", b =>
                {
                    ...
                    b.Property<decimal?>("EvasionScore");
            ...
            modelBuilder.Entity("FCNuvem.FidelizaAluno.Core.Entities.ReasonEntity", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Name = "Distancia" },
                        new { Id = 2, Name = "Financeiro" },
                        new { Id = 3, Name = "Desempenho" },
                        new { Id = 4, Name = "Comportamento" },
                        new { Id = 5, Name = "Aptidão" }
                    );
                });
