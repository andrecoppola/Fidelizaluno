...
namespace FCNuvem.FidelizaAluno.Framework.Extenders
{
    public static class StringExtender
    {
        ...
        public static string ToUrlFriendly(this string text)
        {
            ...
            text = text.RemoveAccentuation().Trim();
        ...
        #region Format
        public static string FormatText(this string text, params object[] args) => string.Format(text, args);

        #endregion

        #region IsValidJson

        public static bool IsValidJson(this string strInput) => IsValidJson(strInput, out var jToken);

        public static bool IsValidJson(this string strInput, out JToken jToken)
        {
